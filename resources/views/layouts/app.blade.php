...
<body>
    ...
    @auth
        <button class="open-button onAbove btn-success btn-sm" onclick="openForm()">Chat</button>
        <div class="chat-popup onAbove" id="myForm">
            <form action="" class="form-container">
                <h1>Chat</h1>
                <div class="container">
                    <label for="msg" id="asdmsg"><b>Message</b></label>
                    <ul id="list-chat">
                    </ul>
                </div>
                ...
                <button type="button" class="btn-sm btn cancel" onclick="closeForm()">Close</button>
            </form>
        </div>
    @endauth
